...
<script type="text/javascript" src="${public_url}min/b=codemirror/addon/search&amp;f=searchcursor.js,match-highlighter.js"></script>
...
<script type="text/javascript" src="${public_url}codemirror/addon/search/searchcursor.js"></script>
<script type="text/javascript" src="${public_url}codemirror/addon/search/match-highlighter.js"></script>
<script type="text/javascript" src="${public_url}codemirror/emmet.min.js"></script>
EOF;
...
<script type="text/javascript" src="${public_url}min/f=codemirror/addon/edit/matchbrackets.js"></script>
<script type="text/javascript" src="${public_url}codemirror/emmet.min.js"></script>
...
$maxi = <<<EOF
\n<script type="text/javascript" src="${public_url}codemirror/mode/css/css.js"></script>
<script type="text/javascript" src="${public_url}codemirror/addon/edit/matchbrackets.js"></script>
<script type="text/javascript" src="${public_url}codemirror/emmet.min.js"></script>
EOF;
